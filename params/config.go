...
var (
	...
	// and accepted by the Twinbot core developers into the Ethash consensus.
	//
	...
	// and accepted by the Twinbot core developers into the Clique consensus.
	//
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
...
// CheckConfigForkOrder checks that we don't "skip" any forks, gtwb isn't pluggable enough
