...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gtwb.ipc", false, filepath.Join(os.TempDir(), "gtwb.ipc")},
		{"data", "gtwb.ipc", false, "data/gtwb.ipc"},
		{"data", "./gtwb.ipc", false, "./gtwb.ipc"},
		{"data", "/gtwb.ipc", false, "/gtwb.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gtwb.ipc", true, `\\.\pipe\gtwb.ipc`},
		{"data", "gtwb.ipc", true, `\\.\pipe\gtwb.ipc`},
		{"data", `\\.\pipe\gtwb.ipc`, true, `\\.\pipe\gtwb.ipc`},
	}
