...
type NodeConfig struct {
	...
	// EthereumEnabled specifies whether the node should run the Twinbot protocol.
	EthereumEnabled bool

	// EthereumNetworkID is the network identifier used by the Twinbot protocol to
...
// Node represents a GsorTwinbot node instance.
type Node struct {
	node *node.Node
}
...
func NewNode(datadir string, config *NodeConfig) (stack *Node, _ error) {
	...
	// Register the Twinbot protocol if requested
...
// GetEthereumClient retrieves a client to access the Twinbot subsystem.
