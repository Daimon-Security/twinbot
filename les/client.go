...
// Package les implements the Light Twinbot Subprotocol.
package les
...
import (
	...
	"github.com/Daimon-Security/twinbot/common/mclock"
	...
	"github.com/Daimon-Security/twinbot/les/downloader"
	"github.com/Daimon-Security/twinbot/les/vflux"
	vfc "github.com/Daimon-Security/twinbot/les/vflux/client"
	"github.com/Daimon-Security/twinbot/light"
	...
	"github.com/Daimon-Security/twinbot/p2p/enr"
...
// APIs returns the collection of RPC services the twinbot package offers.
...
// light twinbot protocol implementation.
...
func (s *LightEthereum) Stop() error {
	...
	s.lesDb.Close()
	s.wg.Wait()
	log.Info("Light twinbot stopped")
	return nil
}
