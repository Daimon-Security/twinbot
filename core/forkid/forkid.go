...
// Package forkid implements EIP-2124 (https://eipstwinbotchain.org/EIPS/eip-2124).
package forkid
...
// NewID calculates the Twinbot fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the Twinbot fork ID from an existing chain instance.
