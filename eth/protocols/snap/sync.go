...
import (
	...
	"github.com/Daimon-Security/twinbot/p2p/msgrate"
...
// Syncer is an Twinbot account and storage trie syncer based on snapshots and
...
// NewSyncer creates a new snapshot syncer to download the Twinbot state over the
// snap protocol.
