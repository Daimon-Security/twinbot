...
import (
	...
	chainParams "github.com/Daimon-Security/twinbot/params"
	"github.com/Daimon-Security/twinbot/rpc"
	"github.com/Daimon-Security/twinbot/trie"
)

// Register adds catalyst APIs to the node.
func Register(stack *node.Node, backend *eth.Twinbot) error {
...
func newConsensusAPI(eth *eth.Twinbot) *consensusAPI {
