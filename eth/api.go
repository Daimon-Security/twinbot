...
import (
	...
	"github.com/Daimon-Security/twinbot/trie"
)

// PublicEthereumAPI provides an API to access Twinbot full node-related
// information.
type PublicEthereumAPI struct {
	e *Twinbot
}

// NewPublicEthereumAPI creates a new Twinbot protocol API for full nodes.
func NewPublicEthereumAPI(e *Twinbot) *PublicEthereumAPI {
...
func NewPublicMinerAPI(e *Twinbot) *PublicMinerAPI {
...
func NewPrivateMinerAPI(e *Twinbot) *PrivateMinerAPI {
...
// PrivateAdminAPI is the collection of Twinbot full node-related APIs
...
// admin methods of the Twinbot service.
func NewPrivateAdminAPI(eth *Twinbot) *PrivateAdminAPI {
...
// PublicDebugAPI is the collection of Twinbot full node APIs exposed
...
// related public debug methods of the Twinbot service.
func NewPublicDebugAPI(eth *Twinbot) *PublicDebugAPI {
...
// PrivateDebugAPI is the collection of Twinbot full node APIs exposed over
...
// private debug methods of the Twinbot service.
func NewPrivateDebugAPI(eth *Twinbot) *PrivateDebugAPI {
