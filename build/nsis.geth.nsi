...
# 1. install gtwb for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gtwb
# 5. create gtwb, attach and uninstall start menu entries
...
!define GROUPNAME "Twinbot"
!define APPNAME "Geth"
!define DESCRIPTION "Official Go implementation of the Twinbot protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gtwb is installed global
