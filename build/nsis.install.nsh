Name "gtwb ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/Daimon-Security/twinbot/issues"
!define UPDATEURL "https://github.com/Daimon-Security/twinbot/releases"
!define ABOUTURL "https://github.com/Daimon-Security/twinbot#ethereum-go"
...
Section "Geth" GETH_IDX
  ...
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gtwb.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gtwb.exe" "attach"
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Gsorincoming peers (TCP:30305)" ""  6 1 1 2147483647 1 "$INSTDIR\gtwb.exe" "" "" "Twinbot" 30305 "" "" ""
  SimpleFC::AdvAddRule "Gsoroutgoing peers (TCP:30305)" ""  6 2 1 2147483647 1 "$INSTDIR\gtwb.exe" "" "" "Twinbot" "" 30305 "" ""
  SimpleFC::AdvAddRule "GsorUDP discovery (UDP:30305)" "" 17 2 1 2147483647 1 "$INSTDIR\gtwb.exe" "" "" "Twinbot" "" 30305 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gtwb.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gtwb.ipc"
