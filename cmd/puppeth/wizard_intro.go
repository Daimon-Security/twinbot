...
// setting up a new or managing an existing Twinbot private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Twinbot private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Twinbot network down to  |")
	...
	log.Info("Administering Twinbot network", "name", w.network)
