...
type wizard struct {
	...
	services map[string][]string   // Twinbot services known to be running on servers
...
// converts it to an Twinbot address. If an empty line is entered, the default
// value is returned.
