...
import (
	...
	"github.com/Daimon-Security/twinbot/signer/core"
	"github.com/Daimon-Security/twinbot/signer/core/apitypes"
	"github.com/Daimon-Security/twinbot/signer/fourbyte"
	"github.com/Daimon-Security/twinbot/signer/rules"
	"github.com/Daimon-Security/twinbot/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage Twinbot account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
...
func checkFile(filename string) error {
	...
	// https://github.com/Daimon-Security/twinbot/issues/20123
