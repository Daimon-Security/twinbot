...
import (
	...
	"github.com/Daimon-Security/twinbot/accounts/external"
	"github.com/Daimon-Security/twinbot/accounts/keystore"
	"github.com/Daimon-Security/twinbot/accounts/scwallet"
	"github.com/Daimon-Security/twinbot/accounts/usbwallet"
	"github.com/Daimon-Security/twinbot/cmd/utils"
	"github.com/Daimon-Security/twinbot/eth/catalyst"
...
func defaultNodeConfig() node.Config {
	...
	cfg.IPCPath = "gtwb.ipc"
	return cfg
}

// makeConfigNode loads gtwb configuration and creates a blank node instance.
...
// makeFullNode loads gtwb configuration and creates the Twinbot backend.
func makeFullNode(ctx *cli.Context) (*node.Node, ethapi.Backend) {
	...
	// Add the Twinbot Stats daemon if requested.
	if cfg.Ethstats.URL != "" {
