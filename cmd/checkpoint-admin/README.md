...
```shell
go get github.com/Daimon-Security/twinbot/cmd/checkpoint-admin
```
...
It is worth noting that checkpoint-admin only supports clef as a signer for transactions and plain text(checkpoint). For more clef usage, please see the clef [tutorial](https://gtwbtwinbotchain.org/docs/clef/tutorial) .
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/Daimon-Security/twinbot/blob/master/params/config.go#L251).*
...
* Start gtwb with the modified configuration file
