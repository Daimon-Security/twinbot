...
// mapped from textual names used in the tests below to actual Twinbot private
...
// address retrieves the Twinbot address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Twinbot address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/Daimon-Security/twinbot/issues/17593). Whilst this
