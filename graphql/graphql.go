...
// Package graphql provides a GraphQL interface to Twinbot node data.
package graphql
...
// Account represents an Twinbot account at a particular block.
type Account struct {
...
// Transaction represents an Twinbot transaction.
...
// Block represents an Twinbot block.
...
type CallData struct {
	From                 *common.Address // The Twinbot address the call is from.
	To                   *common.Address // The Twinbot address the call is to.
