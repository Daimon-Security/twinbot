...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte Twinbot address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an Twinbot account at a particular block.
    type Account {
    ...
    # Transaction is an Twinbot transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an Twinbot account at the current block's state.
    ...
    type Pending {
      ...
      transactions: [Transaction!]
      # Account fetches an Twinbot account for the pending state.
      account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an Twinbot block by number or by hash. If neither is
