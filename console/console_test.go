...
import (
	...
	"github.com/Daimon-Security/twinbot/internal/jsre"
...
func newTester(t *testing.T, confOverride func(*ethconfig.Config)) *tester {
	...
	// Create a networkless protocol stack and start an Twinbot service within
	...
	if err != nil {
		t.Fatalf("failed to register Twinbot protocol: %v", err)
	}
